...
class TestDynamoTimed(TestCase):
    ...
    def test_dynamo_timed(self, mock_time, mock_time_ns):
        ...
        self.assertExpectedInline(
            ...
            filter_expected(
                """\
{'CppCodeCache.compile_main': [0.0, 0.0],
 'CppCodeCache.load_library': [0.0, 0.0],
 'CppCodeCache.write_main_source': [0.0, 0.0],
 ...
 'PyCodeCache.compile_module': [0.0, 0.0],
 'PyCodeCache.exec_module': [0.0, 0.0],
 'PyCodeCache.load_by_key_path': [0.0, 0.0],
 'PyCodeCache.read_source': [0.0, 0.0],
 'PyCodeCache.reload_module': [0.0, 0.0],
